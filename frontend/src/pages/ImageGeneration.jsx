...
//                     </div>
//                 </div>
//                 <button className="cursor-not-allowed bg-black mt-8 text-white px-4 py-2 rounded-xl flex items-center justify-center gap-2"><RiAiGenerate2 /> Generate Image</button>
//             </div>

            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-14 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:items-start lg:items-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        <h2 className="font-semibold mb-3 sm:mb-5 text-gray-800 text-base">Company</h2>
                        <a className="hover:text-slate-600 transition py-0.5" href="#">About us</a>
                        <a className="hover:text-slate-600 transition py-0.5 flex items-center flex-wrap gap-2" href="#">
                            Careers
                            <span className="text-xs text-white bg-indigo-600 rounded-md px-2 py-1 whitespace-nowrap">
                                We're hiring!
                            </span>
                        </a>
                        <a className="hover:text-slate-600 transition py-0.5" href="#">Contact us</a>
                        <a className="hover:text-slate-600 transition py-0.5" href="#">Privacy policy</a>
                    </div>
                </div>
